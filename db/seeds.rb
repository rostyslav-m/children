...
User.create!(email: "ros55@ukr.net",   password: "freedom123", is_admin: true,  name: "Admin")
User.create!(email: "guest@guest.ros", password: "12345678",  is_admin: false, name: "Guest")
